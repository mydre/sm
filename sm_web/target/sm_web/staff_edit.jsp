...
<div id="right_ctn">
    <div class="right_m">
        <div class="hy_list">
            ...
            <form action="edit.do?id=${OBJ.id}" method="post" name="editForm">
                <div class="xjhy">
                    <!--高级配置-->
                    <ul class="hypz gjpz clearfix">
                        ...
                        <li class="clearfix">
                            ...
                            <div class="li_r">
                                <input class="chang" name="bornDate" type="date" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${OBJ.bornDate}"/>"/>
                            </div>
                        </li>
                        <li class="clearfix">
